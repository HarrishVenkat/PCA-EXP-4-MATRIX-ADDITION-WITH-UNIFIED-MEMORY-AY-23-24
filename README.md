...
![image](https://github.com/user-attachments/assets/ef479bc4-c654-4483-9ded-c237019dbe69)
## WITHOUT MEMSET():
![image](https://github.com/user-attachments/assets/dd608ba9-6e11-4558-89ad-9c34c8ec9514)

## RESULT:
Thus the program has been executed by using unified memory. It is observed that removing memset function has given less 0.00859 time.
